...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/ROYALBOMMASR3')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/ROYALBOMMASR2_GROUP'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/ROYALBOMMASR3')
            ],[
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        for msg in msgs:
            ...
            if info.media:
                ...
                if f_caption:
                    f_caption = f"@ROYALBOMMASR3 {f_caption.html}"
                ...
                if f_caption is None:
                    f_caption = f"@ROYALBOMMASR3 {title}"
                if STREAM_MODE == True:
